...
class Request 
{
    ...
    public function checkToken()
    {
        ...
        if((isset($_POST['_crsftoken']) && empty($_POST['_crsftoken'])) || $_POST['_crsftoken'] != $_SESSION['_crsftoken']){
           $session->setFlash('error', 'Invalid crsf token please put crsf token on form!!!');
           //Configuration::sendBack();
           Configuration::redirection('admin/error');
