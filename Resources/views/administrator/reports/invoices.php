                ...
                <div id="switchPoint" class="e-panel card">
                    <div class="card-body">
                        <div class="card-title">
                            <h6 class="mr-2"><span><b class="text-info">REPORT FOR PAID INVOICES</b>  </span><small class="px-1 float-lg-right mb-5"> </small></h6>
                        </div>
                        <div class="e-table">
                            <div class="table-responsive table-lg mt-3">
                                <table class="table table-bordered" id="myTable">
                                    ...
                                    <tbody id="role">
                                        ...
                                        <?php endforeach ?>
                                        <?php else: ?>
                                        <td colspan="10" class="text-danger text-center"><b>No Paid Invoice report found</b></td>
                                        <?php endif; ?>
                                        </tbody>
                                 </table>
                            </div>
